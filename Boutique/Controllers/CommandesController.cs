...
namespace Boutique.Controllers
{
    public class CommandesController : Controller
    {
        ...
        public CommandesController(BoutiqueContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CommandeId,dateCommande,dateLivraison")] Commande commande)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CommandeId,dateCommande,dateLivraison")] Commande commande)
        {
